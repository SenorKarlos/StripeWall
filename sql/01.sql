CREATE TABLE `customers` (
	...
	`team_role` VARCHAR(255) NULL DEFAULT '' COLLATE 'utf8mb4_unicode_ci',
...
CREATE TABLE `qbo_metadata` (
	...
	`customer_type_id` VARCHAR(50) NULL DEFAULT NULL COLLATE 'utf8mb4_unicode_ci',
	`service_product_id` VARCHAR(50) NULL DEFAULT NULL COLLATE 'utf8mb4_unicode_ci',
	`donation_product_id` VARCHAR(50) NULL DEFAULT NULL COLLATE 'utf8mb4_unicode_ci',
	`stripe_fee_expense_id` VARCHAR(50) NULL DEFAULT NULL COLLATE 'utf8mb4_unicode_ci',
	`tax_ids` JSON NULL DEFAULT NULL,
	`stripe_account_id` VARCHAR(50) NULL DEFAULT NULL COLLATE 'utf8mb4_unicode_ci',
	`bank_account_id` VARCHAR(50) NULL DEFAULT NULL COLLATE 'utf8mb4_unicode_ci',
	`invoice_prefix` VARCHAR(7) NULL DEFAULT NULL COLLATE 'utf8mb4_unicode_ci',
	`invoice_sequence` VARCHAR(7) NULL DEFAULT NULL COLLATE 'utf8mb4_unicode_ci',
